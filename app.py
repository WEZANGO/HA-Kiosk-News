...
DEFAULTS = {
    ...
    "background": "dark",
    "vignetteOpacity": "5",
    "textEdgeShadow": "off",        # off | on — shadow only on the side the text sits
}
